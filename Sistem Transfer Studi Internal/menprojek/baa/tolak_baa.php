...
<body>
    ...
    <form action="proses_tolak_baa.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            <label>Pemberitahuan Penolakan</label> <br>
            <input type="file" name="keputusan" required="required" accept="application/pdf">
            <input type="hidden" name="id" value=<?php echo "$id" ?>/>
        </div>
        <div style="margin-top: 1rem">
            <button class="btn btn-success">Upload</button>
            <a href="kaprodi_ditolak.php" class="btn btn-danger">Cancel</a>
        </div>
    </form>
</body>
</html>