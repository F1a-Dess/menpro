            ...
            <div class="page-header clearfix"> 
              ...
              <div class="column right" style="background-color:white;">
                ...
                <div class="page-header clearfix"> 
                  <br>
                  <br>
                  <h3 class="pull-left">&emsp;&emsp;List Bukti Bayar</h3> 
                </div>
                <?php 
                    // Include config file 
                require_once '../config/koneksi.php'; 
                ...
                $sql = "SELECT * FROM data_mhs WHERE bayar = 4"; 
                if($result = $connect->query($sql)){ 
                  if($result->num_rows > 0){ 
                    ...
                    while($row = $result->fetch_array()){ 
                      ...
                      echo "<td>" . $row['nama'] . "</td>";
                      echo "<td>";
                      echo "<a href='bukti_bayar.php?id=". $row['user_id'] ."' title='Bukti Bayar' datatoggle='tooltip'><span class='btn btn-primary'> Bukti Bayar</span></a>";
                      echo "</td>";
                      echo "<td>";  
                      echo "<a href='kirim_nim.php?id=". $row['user_id'] ."' title='Kirim NIM' datatoggle='tooltip'><span class='btn btn-success'> Kirim NIM</span></a>"; 
                      echo "</td>"; 
                      echo "</tr>"; 
                    } 
                    echo "</tbody>";                             
