...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Okt 2020 pada 13.16
...
CREATE TABLE `data_mhs` (
  ...
  `kirim_biaya_studi` int(1) NOT NULL,
  `pemberitahuan_diterima` varchar(255) NOT NULL,
...
INSERT INTO `data_mhs` (`id`, `nama`, `nim_asal`, `prodi_asal`, `fakultas_asal`, `alamat`, `kota`, `nohp`, `smt_pindah`, `thn_akademik_pindah`, `prodi_tujuan`, `fakultas_tujuan`, `transkrip`, `rekomendasi_dosen`, `pernyataan_ortu`, `user_id`, `isi_form`, `upload_berkas`, `cek_form`, `kep_kaprodi`, `konversi`, `kep_baa`, `keputusan`, `biaya_studi`, `rincian_biaya_studi`, `kirim_biaya_studi`, `pemberitahuan_diterima`, `update_rincian_biaya_studi`, `bayar`, `bukti_bayar`, `nim_baru`, `selesai`) VALUES
(1, 'Bambang Nich Uye', '21.N1.0001', 'Sistem Informasi', 'Ilmu Komputer', 'Jalan Sama Dia', 'Weleri', '082381526378', 'ganjil', '2020/2021', 'Teknik Informatika', 'Ilmu Komputer', '25102020110114transkrip.pdf', '25102020110114rekomendasi.pdf', '25102020110114surat_pernyataan_ortu.pdf', 1, 1, 1, 2, 1, '25102020114813FORMULIRKONVERSI.xlsx', 1, '', 1, '25102020115501HasilPenghitunganBiayaStudi.pdf', 1, '25102020131115PemberitahuanPenerimaan.pdf', '', 2, '25102020123326BuktiBayar.pdf', '25102020125032NIMBARU.pdf', 1);
