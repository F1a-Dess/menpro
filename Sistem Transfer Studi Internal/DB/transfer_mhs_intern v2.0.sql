...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Okt 2020 pada 12.36
...
INSERT INTO `data_mhs` (`id`, `nama`, `nim_asal`, `prodi_asal`, `fakultas_asal`, `alamat`, `kota`, `nohp`, `smt_pindah`, `thn_akademik_pindah`, `prodi_tujuan`, `fakultas_tujuan`, `transkrip`, `rekomendasi_dosen`, `user_id`) VALUES
(1, 'Bambang Nich', '21.N1.0001', 'Sistem Informasi', 'Ilmu Komputer', 'Jalan Bareng Aku no 46', 'Semarang', '081234862107', '1', '2021/2022', 'Teknologi Informasi', 'Ilmu Komputer', '', '', 1);
...
(5, 'Teknologi Pangan'),
(6, 'S1 Nutrisi dan Teknologi Kuliner'),
(7, 'Ilmu Hukum'),
(8, 'Ilmu Komunikasi'),
(9, 'Psikologi'),
(10, 'Arsitektur'),
