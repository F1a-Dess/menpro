...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Okt 2020 pada 21.24
...
CREATE TABLE `data_mhs` (
  ...
  `pernyataan_ortu` longblob NOT NULL,
  `user_id` int(11) NOT NULL,
  `isi_form` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `data_mhs` (`id`, `nama`, `nim_asal`, `prodi_asal`, `fakultas_asal`, `alamat`, `kota`, `nohp`, `smt_pindah`, `thn_akademik_pindah`, `prodi_tujuan`, `fakultas_tujuan`, `transkrip`, `rekomendasi_dosen`, `pernyataan_ortu`, `user_id`, `isi_form`, `cek_form`, `kep_kaprodi`, `kep_baa`, `biaya_studi`, `bayar`, `nim_baru`, `selesai`) VALUES
(1, 'Bambang Nich', '21.N1.0001', 'Sistem Informasi', 'Ilmu Komputer', 'Jalan Bareng Aku no 46', 'Semarang', '081234862107', 'genap', '2021/2022', 'Teknologi Informasi', 'Ilmu Komputer', '', '', '', 1, 1, 0, 0, 0, 0, 0, 0, 0),
(2, 'Angelia', '21.N1.0007', 'Teknologi Pangan', 'Teknologi Pertanian', 'Jalan Sama Aku 2', 'Semarang', '082346862348', 'ganjil', '2020/2021', 'Nutrisi dan Teknologi Kul', 'Teknologi Pertanian', '', '', '', 0, 1, 0, 0, 0, 0, 0, 0, 0),
(3, 'Stella', '21.N1.0002', 'Sistem Informasi', 'Ilmu Komputer', 'Jalan Kenangan', 'Jakarta', '082346454765', 'ganjil', '2020/2021', 'Desain Komunikasi Visual', 'Arsitektur dan Desain', '', '', '', 0, 1, 0, 0, 0, 0, 0, 0, 0),
(4, 'Juned', '21.A1.0001', 'Arsitektur', 'Arsitektur dan Desain', 'Jalan Menuju Roma', 'Semarang', '082346454765', 'genap', '2020/2021', 'Sistem Informasi', 'Ilmu Komputer', '', '', '', 0, 1, 0, 0, 0, 0, 0, 0, 0),
(5, 'Renatta', '21.A1.0002', 'Arsitektur', 'Arsitektur dan Desain', 'Jalan Samping Rumahku', 'Semarang', '823298428', 'genap', '2020/2021', 'Sistem Informasi', 'Ilmu Komputer', '', '', '', 0, 1, 0, 0, 0, 0, 0, 0, 0),
(6, 'Marinka', '21.A1.0003', 'Desain Komunikasi Visual', 'Arsitektur dan Desain', 'Jalan Menuju Roma', 'Semarang', '082346860901', 'ganjil', '2020/2021', 'Sastra Inggris', 'Sastra', '', '', '', 0, 1, 0, 0, 0, 0, 0, 0, 0);
